...
public class DirectionUtil {
    ...
    public static <T> Map<Direction, T> directionalData(T north, T south, T west, T east) {
        return Map.of(Direction.NORTH, north, Direction.SOUTH, south, Direction.WEST, west, Direction.EAST, east);
    }

    public static <T> Map<Direction, T> directionalData(T north, T south, T west, T east, T up, T down) {
