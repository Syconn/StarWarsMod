...
public record StackedIngredient(Ingredient ingredient, int count) {
    ...
    public static StackedIngredient of(ItemLike itemLike, int count) {
        return new StackedIngredient(Ingredient.of(itemLike), count);
    }
    ...
    public JsonElement toJson(){
        ...
        if (element instanceof JsonObject object) object.addProperty("count", this.count);
        return element;
    }
}
