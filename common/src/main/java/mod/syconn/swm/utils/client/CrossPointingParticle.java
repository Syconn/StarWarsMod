...
public class CrossPointingParticle extends SimpleAnimatedParticle {
    ...
    public void render(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
        ...
        var f = (float)(MathHelper.lerp(tickDelta, this.xo, this.x) - vec3d.x);
        var g = (float)(MathHelper.lerp(tickDelta, this.yo, this.y) - vec3d.y);
        var h = (float)(MathHelper.lerp(tickDelta, this.zo, this.z) - vec3d.z);
