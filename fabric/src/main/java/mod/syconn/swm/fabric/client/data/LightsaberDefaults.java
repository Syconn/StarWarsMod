...
public class LightsaberDefaults {
    ...
    public enum LightsaberTypes {
        ANAKIN("anakin", createJSON("anakin", 1, true, 1.2f, 1, BLUE, PLASMA, List.of(new NodeVec3(0.00391f, 0.07031f, -0.00047f)))),
        LUKE("luke", createJSON("luke", 1, true, 1.2f, 1, GREEN, PLASMA, List.of(new NodeVec3(0.00071f, 0.02188f, 0f)))),
        MACE("mace", createJSON("mace", 1, true, 1.2f, 0.95f, PURPLE, PLASMA, List.of(new NodeVec3(0.00391f, -0.05469f, -0.00047f)))),
        OBI_WAN("obi", createJSON("obi", 1, true, 1.2f, 1, BLUE, PLASMA, List.of(new NodeVec3(0.00391f, 0.18906f, -0.00047)))),
        YODA("yoda", createJSON("yoda", 1, true, 1.2f, 0.85, GREEN, PLASMA, List.of(new NodeVec3(0f, -0.12656f, 0f)))),
        AHSOKA("ahsoka", createJSON("ahsoka", 1, true, 1.2f, 0.85f, GREEN, PLASMA, List.of(new NodeVec3(0.00391f, -0.06719f, -0.00047f)))),
        DARK_SABER("dark_saber", createJSON("dark_saber", 1, true, 1.2f, 1, WHITE, LightsaberContent.DARK_SABER, List.of(new NodeVec3(0f, 0.62500f, 0f, Axis.YN.rotationDegrees(180f))))),
        TEMPLE_GUARD("temple_guard", createJSON("temple_guard", 1, true, 1.2f, 0.95f, YELLOW, PLASMA, List.of(new NodeVec3(0.00312f, 0.01250f, -0.00156f)))),
        KAL("kal", createJSON("kal", 1, true, 1.4f, 0.95f, BLUE, PLASMA, List.of(new NodeVec3(0.00078f, 0.30469f, -0.00047f)))),
        KYLO("kylo", createJSON("kylo", 1, false, 1.2f, 0.15f, 1, RED, PLASMA, List.of(new NodeVec3(0.00234f, 0.00781f, -0.00203f)),
        ...
        MAUL("maul", createJSON("maul", 1, true, 0.65f, 0.65f, RED, PLASMA, List.of(new NodeVec3(-0.00078f, 0.10625f, -0.00359f),
