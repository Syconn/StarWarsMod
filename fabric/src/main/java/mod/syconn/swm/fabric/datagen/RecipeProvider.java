...
public class RecipeProvider extends FabricRecipeProvider {
    ...
    private void lightsaber(RecipeOutput output, LightsaberDefaults.LightsaberTypes type, Material<?>... materials) {
        LightsaberRecipe.Builder builder = LightsaberRecipe.builder(type.getData().toItem(StringUtil.makeLightsaberName(type.getId())), RecipeProvider::has, RecipeProvider::has);
