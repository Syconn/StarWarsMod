...
public class LightsaberDefaults {
    ...
    public enum LightsaberTypes {
        ...
        DARK_SABER("dark_saber", new LightsaberData(6, true, 1.2f, 1, WHITE, LightsaberContent.DARK_SABER, List.of(
                new NodeVec3(0, -0.6, 0, Vector3f.YN.rotationDegrees(180f))))),
        ...
        KYLO("kylo", new LightsaberData(9, false, 1.1f, 1, RED, PLASMA, List.of(new NodeVec3(-0.0025, -0.005, 0),
                new NodeVec3(0.125, 0.075, 0, Vector3f.ZP.rotationDegrees(90f), 0.15f/1.1f), new NodeVec3(-0.125, 0.075, 0,
                        Vector3f.ZP.rotationDegrees(-90f), 0.15f/1.1f)))),
