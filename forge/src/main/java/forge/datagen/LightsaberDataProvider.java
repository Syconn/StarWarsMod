...
public class LightsaberDataProvider implements DataProvider {
    ...
    public LightsaberDataProvider(DataGenerator data) {
        this.data = data;
    }
    ...
    private Path getPath(String id) {
        return this.data.getOutputFolder(DataGenerator.Target.DATA_PACK).resolve(Constants.MOD).resolve("lightsaber/defaults").resolve(id + ".json");
    }
